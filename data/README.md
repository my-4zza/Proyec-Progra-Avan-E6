...
Los archivos binarios pesados o bases de datos generadas localmente son ignorados automáticamente gracias a la configuración de nuestro archivo `.gitignore`. Si requieres compartir un dataset gigantesco con el equipo, utiliza una nube externa o consulta la sección de Git LFS en nuestro `CONTRIBUTING.md`.

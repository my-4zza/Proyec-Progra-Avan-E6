# Ensamblaje de chasis del carro

# Nota: Este ensamblaje fue cambiado por un arduino UNO, en lugar del FPGA, el ensablaje del arduino UNO se encuentra despues del hecho con el FPGA.

# Conexión de todos los elementos (usando un FPGA)
### En la imagen podemos apreciar la conexión de las baterias (12v) con el regulador de voltaje que permite la conexión de 5v con la Nano Tang 9K
<img width="200" height="300" alt="9771a149-1aee-494b-9ec8-5f938a1ee641" src="https://github.com/user-attachments/assets/9238f402-d4e1-4270-bcf5-b40a33d9e4ad" />

# Muestra del puente H
### En la imagen se aprecia la conexión del puente H con los pines 25 al 30 de la Nano Tang 9K
...
# Conexión sensor seguidor de linea 
### El modelo usado fue un ARD-377 de Steren
...
# Ensamblaje de chasis del carro con Arduino UNO
...
<img width="350" height="450" alt="Brazo completo 3" src="https://github.com/user-attachments/assets/99bcea78-4265-46c7-9aae-47a5870691e5" />
